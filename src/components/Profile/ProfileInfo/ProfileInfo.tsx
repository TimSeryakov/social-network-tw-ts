            ...
            <div className="px-4 text-white">
                ...
                <div className="mt-8">
                    ...
                    <p className="text-theme-text">
                        ...
                        <span
                            className="bg-theme-bg-third inline-block py-1 px-3 mr-2 my-1 rounded-md">#Interstellar</span>
                        ...
                        <span
                            className="bg-theme-bg-third inline-block py-1 px-3 mr-2 my-1 rounded-md">#TypeScript</span>
                        <span
                            className="bg-theme-bg-third inline-block py-1 px-3 mr-2 my-1 rounded-md">#JetBrains</span>
                    </p>
                </div>
            </div>
        </section>
