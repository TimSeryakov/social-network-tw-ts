  ...
  return (
      <div className={userCardStyle} key={props.key}>
        <div className={"w-full sm:w-40 flex items-center justify-center"}>
          <img className={"w-40 h-40 sm:w-32 sm:h-32 bg-theme-bg-secondary rounded-full border border-theme-border my-1 sm:my-3"} src={props.avatar} alt={props.fullName}/>
        </div>
